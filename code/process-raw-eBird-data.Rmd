...
load(here("data/1-raw_eBird_data_2024/locs.RData")) 
```
...
for (i in spfiles) {
  ...
  saveRDS(datmerged, file = here(paste0("data/2-intermediate_eBird_data_2024/species_effort/dat_effort_", spname, ".rds")))
