...
```{r}
#originallly dailylocs has 9 colums and spp7dailylcs has 10 columns. In order to run the function, we need to have the same column. So pad shortest vector with NA's to have same length as longest vector
#length(dailylocs) <- length(spp7dailylocs)

# as.data.frame(dailylocs)
# as.data.frame(spp7dailylocs)
