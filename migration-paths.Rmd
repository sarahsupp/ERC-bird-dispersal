...
EstimateDailyLocs_year = function(dat) {
  ...
  df <- data.frame(DAY = 0, lon = 0, lat = 0, lon_se = 0, lat_se = 0, YEAR =0)
...
ggplot(dailylocs_year, aes(DAY, lat)) + geom_line(size=1) + 
...
The first day distance will be "wrong"" for all years, and it can be omitted after the calculation. 
