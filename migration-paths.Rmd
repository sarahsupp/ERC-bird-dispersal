...
#FIXME: Error in grDevices::dev.off() : QuartzBitmap_Output - unable to open file 'figs/checklist_counts.png'
...
#FIXME: I cannot figure out how to resolve this(Error message: Error in dgcellstogrid(dgg, spp_counts$cell, frame = TRUE, wrapcells = TRUE) : unused arguments (frame = TRUE, wrapcells = TRUE))

#grid <- dgcellstogrid(dgg, spp_counts$cell, frame=TRUE, wrapcells=TRUE) ->not working 
grid <- dgcellstogrid(dgg, spp_counts$cell) #-> working.. IS this correct?
