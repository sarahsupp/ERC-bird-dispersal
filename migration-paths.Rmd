...
#rename column
#old column name = YEAR, DAY
#new column name = year, day

#names(weighted_mean_locs)[names(weighted_mean_locs) == 'YEAR'] <- 'year'
#names(weighted_mean_locs)[names(weighted_mean_locs) == 'DAY'] <- 'day'
