...
mod1_spring <- lm(spring ~ year, data=cedrorum)
summary(mod1_spring)

#linear regression for fall
mod1_fall <- lm(spring ~ year, data=cedrorum)
summary(mod1_fall)
...
mod2_spring <- lm(spring ~ year, data=purpureus)
summary(mod2_spring)

mod2_fall <- lm(fall ~ year, data=purpureus)
summary(mod2_fall)
...
mod3_spring <- lm(spring ~ year, data=mustelina)
summary(mod3_spring)

mod3_fall <- lm(fall ~ year, data=mustelina)
summary(mod3_fall)
...
mod4_spring <- lm(spring ~ year, data=hyemalis_spring)
summary(mod4_spring)

mod4_fall <- lm(fall ~ year, data=hyemalis_spring)
summary(mod4_fall)
...
mod5_spring <- lm(spring ~ year, data=coronata)
summary(mod5_spring)

mod5_fall <- lm(fall ~ year, data=coronata)
summary(mod5_fall)
...
mod6_spring <- lm(spring ~ year, data=sialis)
summary(mod6_spring)

mod6_fall <- lm(fall ~ year, data=sialis)
summary(mod6_fall)
...
mod7_spring <- lm(spring ~ year, data=migratorius)
summary(mod7_spring)

mod7_fall <- lm(fall ~ year, data=migratorius)
summary(mod7_fall)
