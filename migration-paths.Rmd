...
Est3MigrationDates = function(dat){
  ...
  for (s in species) {
   ...
   # ALSO ADDED NA.RM=TRUE ARGUMENT, DOES THIS HAVE ANY DOWNSIDES?
    ...
    spring_index = intersect(c(11:190), dat_subset$day) # between 11 Jan and 9 July #FIXME: what should these dates be, they don't match #190: july 9, index: finding exact date of the migration date
    #TODO: double check index dates 
