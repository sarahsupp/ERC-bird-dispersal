...
library(ggmap)
#library(maptools) #FIXME: Linux install issues
library(fields)
library(sp)
library(raster)
library(maps)
...
library(rgdal)
<<<<<<< HEAD
#library(gamm4) #FIXME: Linux install issues
#library(tidyverse) #FIXME: Linux install issues
library(dplyr)
library(ggplot2)
...
library(geosphere)
#library(mgcv)  #FIXME: Linux install issues
# library(radiant.data)  #FIXME: Linux install issues
library(mgcv)
