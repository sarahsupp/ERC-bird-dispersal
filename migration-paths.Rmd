...
* Yellow-rumped Warbler (YEWA) _Cetophaga coronata_
...
load("data/effort_2020-08.Rdata") # will come in as eft.c, FAL named previously
load("data/locs_2020-08.Rdata") # will come in as loc, FAL named previously
...
#now merge with the third data file for effort dat_effort = merge(dat_merged,
eft.c, by.x = c("POLYFID", "YEAR", "DAY"), by.y = c("POLYFID","YEAR",  "DAY"))
dat_effort$DAY <- as.numeric(dat_effort$DAY) save(dat_effort, file =
"data/dat_effort.RData")
```
