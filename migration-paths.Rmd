...
library(mgcv)
library(maptools)
#library(nvctr) #won't need once I move nvector method to a new Rmd file. Want to keep this file for analysis
...
Centroid file from daily-nvector-centroids.Rmd
- df_nvector.rds
...
df_nvector <- readRDS("data_2023/df_nvector_2023.rds") #previously called "df" in code: FIXME: delete this note once all is checked
