...
For *blue jay*
```{r}
load("data/Cyanocitta_cristata.RData") # will come in as ebrd2.c, FAL named previously
...
For *wood thrush*
```{r}
load("data/Hylocichla_mustelina.RData") # will come in as ebrd2.c, FAL named previously
...
# #merge locations data on POLYFID so it includes the center of each hex cell (LONGITUDE.y, LATITUDE.y)
  ...
  save(dat_effort, file = "data/dat_effort_WOTH.RData")
```

For *robin*
```{r}
load("data/Turdus_migratorius.Rdata") # will come in as ebrd2.c, FAL named previously
...
```{r}
load("data/Setophaga_coronata.Rdata") # will come in as ebrd2.c, FAL named previously
...
# #merge locations data on POLYFID so it includes the center of each hex cell (LONGITUDE.y, LATITUDE.y)
  ...
  save(dat_effort, file = "data/dat_effort_YEWA.RData")
```
