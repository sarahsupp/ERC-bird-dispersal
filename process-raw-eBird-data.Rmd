...
# raw eBirder data, queried by FAL
 load("data_2023/raw_eBird_data_2023/effort-count_2023.Rdata") 
 # (2020) will load as eft.c, FAL named previously
 # (2022) will load as dat, FAL named previously

 load("data_2023/raw_eBird_data_2023/locs_2023.Rdata") 
...
```{r}
spfiles = list.files(path=here("data_2023/raw_eBird_data_2023/species/"), pattern=glob2rx("*.RData"))

for (i in spfiles) {
  # These RData files have one object and it is named "dat2" 
  load(paste0(here("data_2023/raw_eBird_data_2023/species/"),(i)))
  ...
  saveRDS(dat_effort, file = paste0("data_2023/effort-merged_data_2023/dat_effort_", spname, ".rds"))
}
```
