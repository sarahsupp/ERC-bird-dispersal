...
my_spdf <- readOGR(dsn = "data/ERC_shapefile_2023", layer = "junivirg")
```
...
BBL <- readRDS("data/BBL_data/BBL2022.rds")
...
ERC_range_sf <- st_read("data/ERC_shapefile_2023/junivirg.shp", quiet = TRUE) %>%
...
saveRDS(BBL_in_range, "data/BBL_data/BBL_in_range_2022.rds")
```
...
saveRDS(BBL, "data/BBL_data/BBL2022.rds")
```
