...
plot(US_CAN_spdf,
     ...
     col = "white", lwd = 0.25, border = 1, xlim = c(-130, 0), ylim = c(25,50))
...
plot(US_CAN_spdf,
     ...
     col = "white", lwd = 0.25, border = 1, xlim = c(-130, -45), ylim = c(25,50))
...
plot(US_CAN_spdf,
     main = "Map of US and Canada\nWith Blue Jay ranges",
     col = "white", lwd = 0.25, border = 1, xlim = c(-130, -20), ylim = c(25,50))
...
plot(US_CAN_spdf,
     ...
     col = "white", lwd = 0.25, border = 1, xlim = c(-130, -10), ylim = c(25,50))
